    ...
    <div className="flex flex-col md:flex-row bg-[#F9FAFB] min-h-screen">
      <div className="relative w-full md:w-[45%] overflow-hidden bg-gradient-to-b from-[#3B9AB8] to-[#54B9ED] md:bg-none">
        <img
          ...
          alt="Frame"
          className="h-[400px] md:h-[720px] w-full hidden md:block md:bg-blue-600"
        />
        <img
          src="/assets/images/upper.png"
          alt="upper"
          className="absolute bottom-0 left-0 h-[300px] md:h-[500px] w-full object-cover hidden md:block"
        />
      </div>

      <div className="w-full md:w-[55%] flex flex-col justify-center items-center px-8 md:px-12 py-8 md:py-0">
        <h1 className="text-3xl md:text-4xl font-semibold text-[#3B9AB8] mb-6 md:mb-8 text-center">
          Healthcare CMS
        </h1>

        <UserTypeSelector mode="signin" usertype={usertype} setUsertype={setUsertype} />
